...
1. **选择模式并开局：** 自由生涯每次抽取新事件；今日挑战在同一天使用固定种子，方便与朋友对照选择。
...
6. **收集并分享：** 生涯档案会收集十二种结局和十二项成就；结局总结可复制给朋友。
...
两种模式都从入行求职开始，依次经历初级生存、独当一面、核心骨干、路线分叉和职业答案。相同种子配合相同选择会得到一致结果，但选择触发的隐藏经历仍会改变后续候选事件。
