...
Page({
  ...
  load() {
    ...
    this.setData({ trip, summary, ledgers: ledgers.map((ledger) => ({ ...ledger, linked: trip.linkedLedgerIds.indexOf(ledger.id) >= 0 })), "expense.currency": trip.baseCurrency, "expense.date": trip.startDate });
  },
